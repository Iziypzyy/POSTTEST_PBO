...
public class Main {
    public static void main(String[] args) {
        ...
        // Demo Overriding & Overloading langsung berjalan saat program dimulai
        System.out.println("=== TEST POLYMORPHISM BREWSOCIETY ===");
        
        // Test Overriding (Polimorfisme Dinamis)
        ...
        // Test Overloading (Polimorfisme Statis) pada method di class Pengguna
        pelangganTest.tampilkan(true); // Memanggil method tampilkan(boolean) yang mencetak garis batas
        
        // Test Overloading pada MenuKopi
        MenuKopi kopiPromo = new MenuKopi("K01", "Kopi Susu Gula Aren", 25000);
        kopiPromo.setHarga(25000, 5000); // Set harga normal 25000 tapi di-overload dengan diskon 5000
    ...
    // Fungsi CRUD Menu Kopi (Sesuai Posttest Sebelumnya)
        ...
        if (aksi.equals("1")) {
            ...
            if (daftarMenu.isEmpty()) {
                ...
                for (MenuKopi m : daftarMenu) {
                    m.tampilkan(); // Akan memanggil Overloading 4
                }
            }
        }
    }

    // Fungsi CRUD Pelanggan (Sesuai Posttest Sebelumnya)
    // Pastikan kode ini berada di dalam class Main, tapi di luar public static void main
    ...
    // Fungsi CRUD Barista (Sesuai Posttest Sebelumnya)
        ...
        if (aksi.equals("1")) {
            ...
            if (daftarBarista.isEmpty()) {
                ...
                for (Barista b : daftarBarista) {
                    b.tampilkan(); // Akan memanggil Overriding dari Barista
                }
            }
        }
    }
